  ...
  return (
    ...
    >
      <Form className='flex flex-col w-2/5 gap-4'>
        ...
        <Field id='name' name='name' placeholder='Enter your name' className='bg-inherit border-2 rounded-xl p-2.5 outline-transparent' />
        <label htmlFor='email' className='after:content-["*"] after:ml-0.5 after:text-red-500'>Email address</label>
        <Field id='email' name='email' type='email' placeholder='Enter your email address' className='bg-inherit border-2 rounded-xl p-2.5 outline-transparent' />
        ...
        <button type='submit' className='font-bold border-2 rounded-xl py-2.5 px-3.5 mx-auto hover:bg-[rgba(248,252,251,0.3)]'>Sign Up</button>
      </Form>
    </Formik>
  )
}
